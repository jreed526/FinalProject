...
public class EnemyBehavior : MonoBehaviour
{
    ...
    // Reference to BlinkColorOnHit component
    ...
    protected virtual void Start()
    {
        ...
        // Get the BlinkColorOnHit component
        blinkColorOnHit = GetComponent<BlinkColorOnHit>();
        if (blinkColorOnHit == null)
        {
            Debug.LogError("BlinkColorOnHit component not found on " + gameObject.name);
        }
    }
    ...
    public virtual void TakeDamage(int damage)
    {
        ...
        // Trigger the blink effect if the BlinkColorOnHit component exists
        if (blinkColorOnHit != null)
        {
            blinkColorOnHit.Blink(false); // Pass 'false' because it's not a shielded hit
        }
